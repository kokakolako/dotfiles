...
complete -c efibootmgr -s e -l edd -s 1 --description 'Force EDD 1. 0 or 3. 0 creation variables, or guess.'
complete -c efibootmgr -s E -l device --description 'EDD 1. 0 device number (defaults to 0x80).'
...
complete -c efibootmgr -l test --description 'Don\'t write to NVRAM, write to filename.'
